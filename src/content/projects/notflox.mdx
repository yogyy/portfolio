...
banner: https://res.cloudinary.com/dpegakmzh/image/upload/t_notflox_thumb/v1702493046/notflox_thumb_i9qblu.webp
url: https://notflox.vercel.app/
techs: NextJS, Tailwind, RadixUI, SwiperJS, MongoDB, ReactQuery
...
<div className="not-prose mt-2">
  <TechMdx techs={['nextjs', 'tailwindcss', 'radix', 'swiperjs', 'mongodb', 'reactquery']} />
</div>
