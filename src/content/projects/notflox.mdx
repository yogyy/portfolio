...
banner: https://res.cloudinary.com/dpegakmzh/image/upload/v1686663246/notflox_preview_fc7g8r.webp
...
<div className="mt-2 not-prose">
  <TechMdx techs={['nextjs', 'tailwindcss', 'headui', 'mui', 'mongodb', 'reactqeury']} />
</div>
...
- Material UI: Used for additional UI components.
