...
banner: https://res.cloudinary.com/dpegakmzh/image/upload/v1697532810/new_notflox_soggio.webp
url: https://yogyy-notflox.netlify.app
techs: NextJS, Tailwind, HeadlessUI, RadixUI, MongoDB, ReactQuery
...
<div className="mt-2 not-prose">
  <TechMdx techs={['nextjs', 'tailwindcss', 'headui', 'radix', 'mongodb', 'reactqeury']} />
</div>
...
- Headless UI: Used for accessible and reusable UI components.
