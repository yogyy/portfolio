...
export const logoLI = logoLinkedin;
export const logoFB = logoFacebook;
export const logoGH = logoGithub;
export const logoTW = logoTwitter;
export const Mail = logoMail;
...
export function MailOutline() {
  return (
    ...
    >
      ...
      <polyline points="112 160 256 272 400 160" fill='none' stroke='currentColor' strokeLinecap='round' strokeLinejoin='round' strokeWidth={32} />
    </svg>
  );
}
